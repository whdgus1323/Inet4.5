...
Define_Module(Hcf); // @suppress("Abstract class cannot be instantiated")
...
void Hcf::initialize(int stage)
{
    ...
    if (stage == INITSTAGE_LOCAL) {
        ...
        rtsProcedure = new RtsProcedure(); // @suppress("Abstract class cannot be instantiated")
        rtsPolicy = check_and_cast<IRtsPolicy *>(getSubmodule("rtsPolicy"));
        recipientAckProcedure = new RecipientAckProcedure(); // @suppress("Abstract class cannot be instantiated")
        ctsProcedure = new CtsProcedure(); // @suppress("Abstract class cannot be instantiated")
        ...
        if (originatorBlockAckAgreementPolicy && recipientBlockAckAgreementPolicy) {
            recipientBlockAckAgreementHandler = new RecipientBlockAckAgreementHandler(); // @suppress("Abstract class cannot be instantiated")
            originatorBlockAckAgreementHandler = new OriginatorBlockAckAgreementHandler(); // @suppress("Abstract class cannot be instantiated")
            originatorBlockAckProcedure = new OriginatorBlockAckProcedure(); // @suppress("Abstract class cannot be instantiated")
            recipientBlockAckProcedure = new RecipientBlockAckProcedure(); // @suppress("Abstract class cannot be instantiated")
        }
    }
}
...
void Hcf::recipientProcessReceivedManagementFrame(const Ptr<const Ieee80211MgmtHeader>& header) // @suppress("Member declaration not found")
{
...
void Hcf::originatorProcessTransmittedDataFrame(Packet *packet, const Ptr<const Ieee80211DataHeader>& dataHeader, AccessCategory ac) // @suppress("Member declaration not found")
{
    auto edcaf = edca->getEdcaf(ac);
...
void Hcf::originatorProcessTransmittedManagementFrame(const Ptr<const Ieee80211MgmtHeader>& mgmtHeader, AccessCategory ac) // @suppress("Member declaration not found")
{
    auto edcaf = edca->getEdcaf(ac);
...
void Hcf::originatorProcessReceivedManagementFrame(const Ptr<const Ieee80211MgmtHeader>& header, const Ptr<const Ieee80211MacHeader>& lastTransmittedHeader, AccessCategory ac) // @suppress("Member declaration not found")
{
...
void Hcf::originatorProcessReceivedDataFrame(const Ptr<const Ieee80211DataHeader>& header, const Ptr<const Ieee80211MacHeader>& lastTransmittedHeader, AccessCategory ac) // @suppress("Member declaration not found")
{
...
void Hcf::processMgmtFrame(Packet *mgmtPacket, const Ptr<const Ieee80211MgmtHeader>& mgmtHeader) // @suppress("Member declaration not found")
{
