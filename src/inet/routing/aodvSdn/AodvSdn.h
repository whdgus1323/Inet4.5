...
#ifndef __INET_AODVSDN_H
#define __INET_AODVSDN_H
...
#include "inet/routing/aodvSdn/AodvSdnControlPackets_m.h"
...
class INET_API AodvSdn : public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
  protected:
    /*
  ...
  protected:
    ...
    void sendAODVPacket(const Ptr<AodvSdnControlPacket>& packet, const L3Address& destAddr, unsigned int timeToLive, double delay);
    void processPacket(Packet *pk);
    void clearState();
    void checkIpVersionAndPacketTypeCompatibility(AodvSdnControlPacketType packetType);
