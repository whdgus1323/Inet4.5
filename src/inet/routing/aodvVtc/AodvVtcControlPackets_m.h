...
#ifndef __INET__AODVVTC_AODVVTCCONTROLPACKETS_M_H
#define __INET__AODVVTC_AODVVTCCONTROLPACKETS_M_H
...
/**
 * Enum generated from <tt>inet/routing/aodvVtc/AodvVtcControlPackets.msg:15</tt> by opp_msgtool.
 * <pre>
 * enum AodvVtcControlPacketType
 * {
 *     RREQ = 1;
 *     RREP = 2;
 *     RERR = 3;
...
inline void doParsimPacking(omnetpp::cCommBuffer *b, const AodvVtcControlPacketType& e) { b->pack(static_cast<int>(e)); }
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, AodvVtcControlPacketType& e) { int n; b->unpack(n); e = static_cast<AodvVtcControlPacketType>(n); }

/**
 * Class generated from <tt>inet/routing/aodvVtc/AodvVtcControlPackets.msg:30</tt> by opp_msgtool.
 * <pre>
 * //
 * // Base packet for AODV Control Packets
 * //
 * class AodvVtcControlPacket extends FieldsChunk
 * {
 *     AodvVtcControlPacketType packetType = static_cast<AodvVtcControlPacketType>(-1);       // packet type, stored in one byte
 * }
 * </pre>
 */
class INET_API AodvVtcControlPacket : public ::inet::FieldsChunk
{
  protected:
    AodvVtcControlPacketType packetType = static_cast<AodvVtcControlPacketType>(-1);

  private:
    void copy(const AodvVtcControlPacket& other);

  protected:
    bool operator==(const AodvVtcControlPacket&) = delete;

  public:
    AodvVtcControlPacket();
    AodvVtcControlPacket(const AodvVtcControlPacket& other);
    virtual ~AodvVtcControlPacket();
    AodvVtcControlPacket& operator=(const AodvVtcControlPacket& other);
    virtual AodvVtcControlPacket *dup() const override {return new AodvVtcControlPacket(*this);}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;

    virtual AodvVtcControlPacketType getPacketType() const;
    virtual void setPacketType(AodvVtcControlPacketType packetType);
};

inline void doParsimPacking(omnetpp::cCommBuffer *b, const AodvVtcControlPacket& obj) {obj.parsimPack(b);}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, AodvVtcControlPacket& obj) {obj.parsimUnpack(b);}

/**
 * Class generated from <tt>inet/routing/aodvVtc/AodvVtcControlPackets.msg:38</tt> by opp_msgtool.
 * <pre>
 * //
 * // Represents an AODV Route Request
 * //
 * class Rreq extends AodvVtcControlPacket
 * {
 ...
 * </pre>
 */
class INET_API Rreq : public ::inet::aodvVtc::AodvVtcControlPacket
{
  protected:
    bool joinFlag = false;
...
/**
 * Class generated from <tt>inet/routing/aodvVtc/AodvVtcControlPackets.msg:61</tt> by opp_msgtool.
 * <pre>
 * //
 * // Represents an AODV Route Reply
 * //
 * class Rrep extends AodvVtcControlPacket
 * {
 ...
 * </pre>
 */
class INET_API Rrep : public ::inet::aodvVtc::AodvVtcControlPacket
{
  protected:
    bool repairFlag = false;
...
/**
 * Struct generated from inet/routing/aodvVtc/AodvVtcControlPackets.msg:79 by opp_msgtool.
 */
...
/**
 * Class generated from <tt>inet/routing/aodvVtc/AodvVtcControlPackets.msg:89</tt> by opp_msgtool.
 * <pre>
 * //
 * // Represents an AODV Route Error
 * //
 * class Rerr extends AodvVtcControlPacket
 * {
 ...
 * </pre>
 */
class INET_API Rerr : public ::inet::aodvVtc::AodvVtcControlPacket
{
  protected:
...
/**
 * Class generated from <tt>inet/routing/aodvVtc/AodvVtcControlPackets.msg:101</tt> by opp_msgtool.
 * <pre>
 * //
 * // Represents an AODV Route Reply ACK
 * //
 * class RrepAck extends AodvVtcControlPacket
 * {
 *     chunkLength = B(2);
 ...
 * </pre>
 */
class INET_API RrepAck : public ::inet::aodvVtc::AodvVtcControlPacket
{
  protected:
    uint8_t reserved = 0;
...
/**
 * Class generated from <tt>inet/routing/aodvVtc/AodvVtcControlPackets.msg:111</tt> by opp_msgtool.
 * <pre>
 * //
...
/**
 * Class generated from <tt>inet/routing/aodvVtc/AodvVtcControlPackets.msg:121</tt> by opp_msgtool.
 * <pre>
 * //
...
template<> inline inet::aodvVtc::AodvVtcControlPacket *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::aodvVtc::AodvVtcControlPacket*>(ptr.get<cObject>()); }
template<> inline inet::aodvVtc::Rreq *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::aodvVtc::Rreq*>(ptr.get<cObject>()); }
template<> inline inet::aodvVtc::Rrep *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::aodvVtc::Rrep*>(ptr.get<cObject>()); }
inline any_ptr toAnyPtr(const inet::aodvVtc::UnreachableNode *p) {return any_ptr(p);}
template<> inline inet::aodvVtc::UnreachableNode *fromAnyPtr(any_ptr ptr) { return ptr.get<inet::aodvVtc::UnreachableNode>(); }
template<> inline inet::aodvVtc::Rerr *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::aodvVtc::Rerr*>(ptr.get<cObject>()); }
template<> inline inet::aodvVtc::RrepAck *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::aodvVtc::RrepAck*>(ptr.get<cObject>()); }
template<> inline inet::aodvVtc::WaitForRrep *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::aodvVtc::WaitForRrep*>(ptr.get<cObject>()); }
template<> inline inet::aodvVtc::PacketHolderMessage *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::aodvVtc::PacketHolderMessage*>(ptr.get<cObject>()); }

}  // namespace omnetpp

#endif // ifndef __INET__AODVVTC_AODVVTCCONTROLPACKETS_M_H
