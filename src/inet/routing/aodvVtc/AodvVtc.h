...
#ifndef __INET_AODVVTC_H
#define __INET_AODVVTC_H

#include <map>

#include "AodvVtcRouteData.h"
#include "inet/common/ModuleRefByPar.h"
#include "inet/networklayer/contract/IInterfaceTable.h"
#include "inet/networklayer/contract/IL3AddressType.h"
#include "inet/networklayer/contract/INetfilter.h"
#include "inet/networklayer/contract/IRoutingTable.h"
#include "inet/routing/aodvVtc/AodvVtcControlPackets_m.h"
...
class INET_API AodvVtc : public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
  protected:
    /*
    ...
    std::string pwd;   // ini에서 들어오는 경로
    bool pFlag = false; // L=false, P=true

    // Aodv.h
    cMessage *logRoutingTableTimer = nullptr;
    ...
    bool isRouteInvalidated = false;
    int routeTimeoutCount = 0;
    simtime_t lastRerrTime = 0;       // 마지막 RERR 메시지 전송 시간
    simtime_t rerrMinInterval = 3.5;
  ...
  protected:
    ...
    void sendAODVPacket(const Ptr<AodvVtcControlPacket>& packet, const L3Address& destAddr, unsigned int timeToLive, double delay);
    void processPacket(Packet *pk);
    void clearState();
    void checkIpVersionAndPacketTypeCompatibility(AodvVtcControlPacketType packetType);
